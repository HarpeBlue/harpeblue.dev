...
- [x] 6.4 Add an owner-facing cutover checklist that records mailbox verification, apex/www/legacy domain setup, path/query-preserving permanent redirects, post-deploy checks, and rollback; explicitly report DNS/mail/Vercel production readiness separately from repository completion.
